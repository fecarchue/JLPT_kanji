...
const kanjiData = {
  ...
  middle2: [
    ...
    {
      kanji: "紛",
      reading: "フン、まぎ(れる)、まぎ(らわしい)",
      meaning: "어지러울 분",
    },
    { kanji: "墳", reading: "フン", meaning: "무덤 분" },
    {
      kanji: "崩",
      reading: "ホウ、くず(れる)、くず(す)",
      meaning: "무너질 붕",
    },
    ...
    {
      kanji: "滑",
      reading: "カツ、すべ(る)、なめ(らか)",
      meaning: "미끄러울 활 | 익살스러울 골",
    },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`px-3 py-1 rounded text-xs ${
                  sortBy === "random" ? "bg-blue-500 text-white" : "bg-gray-200"
                }`}
              >
                랜덤
              </button>
